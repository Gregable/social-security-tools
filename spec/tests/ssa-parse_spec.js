const dollarStringToNumber = require('../../src/ssa-parse').dollarStringToNumber;
...
describe("dollarStringToNumber", function () {
  ...
  it("Parses Dollars", function() {
    expect(dollarStringToNumber("$123")).toBe(123);
  });
  it("Parses Dollars with thousands", function() {
...
describe("parsePaste", function() {
  it("Parses Simple Space Delimited Data", function() {
    let pasteData = "2018 $100,000\n2017 $90,000\n2016 $80,000";
    parsePasteExpect(parsePaste(pasteData));
  });
	it("Parses ssa.tools own formatted table", function() {
    let pasteData = (
  ...
  it("Parses ssa.gov format (Chrome, Linux, Full Page)", function() {
    let pasteData = (
        'KSkip to Content\n' +
        'my Social Security\n' +
        'Uncle Sam Sign Out\n' +
  ...
  it("Parses ssa.gov format (Chrome, Linux, Full Table)", function() {
    let pasteData = (
        'Work Year\n' +
        'Taxed Social Security Earnings\n' +
        'Taxed Medicare Earnings\n' +
  ...
  it("Parses ssa.gov format (Chrome, Linux, Table Rows)", function() {
    let pasteData = (
        '2018\t$100,000\t$100,000\n' +
        '2017\t$90,000\t$90,000\n' +
        '2016\t$80,000\t$80,000\n')
  ...
  it("Parses ssa.gov format (Firefox, Linux, Full Page)", function() {
    let pasteData = (
        '\n' +
        'K\n' +
        'Skip to Content\n' +
  ...
  it("Parses ssa.gov format (Firefox, Linux, Full Table)", function() {
    let pasteData = (
        'Work Year\n\t\n' +
        'Taxed Social Security Earnings\n\t\n' +
        'Taxed Medicare Earnings\n' +
  ...
  it("Parses ssa.gov format (Firefox, Linux, Table Rows)", function() {
    let pasteData = (
        '2018 \t$100,000 \t$100,000\n' +
        '2017 \t$90,000 \t$90,000\n' +
        '2016 \t$80,000 \t$80,000\n')
  ...
  it("Parses ssa.gov format with trailing whitespace", function() {
