...
test.describe('StrategyTimeline Component', () => {
  test('should display payment timeline when strategy is selected', async ({ page }) => {
    ...
    await expect(page.locator('.strategy-timeline-container h3')).toContainText('Payment Timeline');
