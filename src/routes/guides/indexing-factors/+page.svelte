  ...
  <div>
    ...
    <p>
      Yesterday, Josh Scandlen posted a <a
        href="https://www.youtube.com/watch?v=JZXymvFm8uw&t=78s"
        >YouTube video</a
      >
    ...
    <p>
      ...
      her social security earnings record into ssa.tools, it displays a table
    ...
    />
    <p>
      We see that in 1984, Alex earned $16,035 which is multiplied by an
      earnings factor of <b>3.35</b> for an indexed earnings value of $16,035 x 3.35
      = $53.765.
    </p>
    <p>
    ...
    <p>
      ...
      too: the ssa.gov numbers are all 52% higher than the ssa.tools numbers.
      Why?
    </p>
    <p>
    ...
    <p>
      ...
      numbers are not just selected by a governing body; there is instead a
      simple formula that determines them. The calculation will actually be made
      in the year that Alex turns 62, which is 2032. In 2032, index factors are
      calculated for Alex for every year up to and including the year she turned
      60. Every year after that, the multiplier will always be 1.0. For the
      years up until 60, the multiplier for a given year will be the Average
      Wage Index (AWI) in the year she turned 60 divided by the AWI of the
      multiplier year:
    </p>
    ...
    <p>
      ...
      the "Average Wage Index". It is the average of all of the wages reported
      by everyone in the country in that year. We can't know that value until at
      least the following year. The data is based on tax returns, so with late
      filing and so forth, the actual number won't really be known until very
      late in the following year, which makes it available for use in the year
      after that (2 years later). This is why 2030 numbers are used in 2032.
    </p>
    <p>
    ...
    <p>
      ...
      earnings factors. 52% is the estimated increase in average wage between
      2019 and 2030. From <a
    ...
    <p>
      ...
      inflation by 2032. We don't know the exact amount, but one estimate might
      be 52% - the amount wages will inflate by then. That $2,800 would then
      cost $2,800 x 1.52 = $4,256.
    </p>
    <p>
    ...
    <p>
      ...
      only one of them, and it varies from price inflation. Typically wages grow
      a little faster than prices. Price inflation also has an effect on the
      formula for your social security benefit. To understand more, take a look
      at our guide on <a href="inflation.html"
    ...
    <p>
      ...
      will likely negatively impact those who turn 60 that year. If you were
      born in 1960, take a look at our guide answering the question: <a
        href="covid-awi-drop.html"
        >Will a weak economy in 2020 result in a benefits decrease for those
        born in 1960?</a
      >
    </p>
  </div>
