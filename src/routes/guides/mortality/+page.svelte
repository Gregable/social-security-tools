...
<style>
  ...
  .multiplier-interpretation table {
    border-collapse: collapse;
    width: 100%;
  }
  .multiplier-interpretation th,
  .multiplier-interpretation td {
    padding: 0.4rem 0.6rem;
    text-align: left;
    border-bottom: 1px solid #ddd;
    line-height: 1.25;
  }
  .multiplier-interpretation thead th {
    background: #f0f0f0;
  }
  .multiplier-interpretation tbody tr:last-child td {
    border-bottom: none;
  }
  .multiplier-interpretation tbody tr.baseline {
    background: #f5f7ff;
  }
  .hero-float {
    float: right;
