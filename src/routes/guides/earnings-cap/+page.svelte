...
<p>
  ...
  limit is $160,200. Earnings above that amount are not subject to payroll tax,
  and do not affect your social security benefit, <abbr
...
<p>
  The cap for years 1937 - 1974 and for 1979 - 1981 was set by statute. The cap
  for all other years is set by an automatic calculation as specified by the
  Social Security Act.
</p>
<p>
  The formula for a given year X takes the National Average Wage Index (AWI) for
  year (X - 2), divides this by $22,935.42 which was the AWI in 1992, and
