...
spouseLowEarner.birthdate = new Birthdate(new Date('1950-07-01'));
...
spouseZeroEarner.birthdate = new Birthdate(new Date('1950-07-01'));
...
spouseHighEarner.birthdate = new Birthdate(new Date('1950-07-01'));

const meta: Meta<SpousalReport> = {
  component: SpousalReport,
  title: 'Report/Combined/SpousalReport',
  tags: ['autodocs'],
  parameters: {
    layout: 'fullscreen',
  },
